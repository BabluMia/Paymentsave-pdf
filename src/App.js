      ...
      <form className="normal uk">
        ...
        <section>
              ...
              <div className="input">
                <div className="check">
                  ...
                  <label htmlFor="af_s4_q33_1">
                    ...
                    <em>
                      (I confirm that I am engaged in business activities but
                      not registered for VAT in the European Union)
                    </em>
                  </label>
                </div>
              </div>
          ...
          <div className="row">
            <div className="cols-10">
              <label>
                *Please state the country which generates the highest revenue
                per annum for your business. If you operate in only one country,
              ...
              <div className="input">
                <div className="radio">
                  ...
                  <label htmlFor="af_s4_q24_1">
                    Level 4 : Processing less than 20,000 Internet Transactions
                    or up to 1 million MO/TO and Card Present Transactions p.a.
                  </label>
                </div>
              </div>
            </div>
        ...
        <section className="page-break">
          ...
          <div className="row">
            <div className="cols-10 grey no-border">
              ...
              <p>
                ...
                individual who is the beneficial owner of the Customer.
                Beneficial Owners are those individuals who are the business
                owners (e.g. Sole Traders) or who directly or indirectly hold
                25% or more of the shares/voting rights (“Interest / control”)
                of the Customer. In the case of a complex structure, please
                provide details of any individual holding, directly or
                indirectly, 10% or more of the Interest.
              </p>
              <p>
              ...
              <p>
                ...
                tick all appropriate boxes and provide the required information
                by only completing the section once.
              </p>
              <p>
                A “Responsible Party” is an individual who has control over the
                day-to-day operations of the business. Please ensure that at
                least one of the individuals identified below is a Responsible
                Party.
              </p>
          ...
          <div className="bo page-break">
            <h2>
              1){" "}
              <input name="af_s5_p1_q0-1" id="af_s5_p1_q0-1" type="checkbox" />{" "}
            ...
            <div className="row">
              <div className="cols-6-6">
                <label>
                  Nationality/Citizenship (**mandatory for Authorised
                  Signatories &amp; Beneficial Owners only)
                </label>
                <div className="input">
                  <input
                    type="text"
          ...
          <div className="bo">
            <h2>
              2){" "}
              <input name="af_s5_p2_q0-1" id="af_s5_p2_q0-1" type="checkbox" />{" "}
              Authorised Signatory{" "}
          ...
          <div className="bo">
            <h2>
              3){" "}
              <input name="af_s5_p3_q0-1" id="af_s5_p3_q0-1" type="checkbox" />{" "}
              Authorised Signatory{" "}
          ...
          <div className="bo page-break">
            <h2>
              4){" "}
              <input name="af_s5_p4_q0-1" id="af_s5_p4_q0-1" type="checkbox" />{" "}
              Authorised Signatory{" "}
                  ...
                  <div className="input">
                    <div className="check">
                      <input
                        ...
                        id="af_s9_q4_1"
                      />
                      <label htmlFor="af_s9_q4_1">
                        Funding Statement (EDI)
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div className="row no-border page-break">
            <div className="cols-10 text-justify">
              ...
              <p>
                ...
                you and/or your business partners and guarantors and where you
                are a company or limited liability partnership, may relate to
                your officers, shareholders, partners, owners and guarantors.
              </p>
              <p>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      ...
                      (as such term is defined in the TOS)
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      ...
                      Elavon, its Affiliates or third parties, whether relating
                      to Merchant Services or otherwise
                    </td>
                    <td>Legitimate interests</td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      information with others from time to time. This regards
                      use of records of the transactions in combination with the
                  ...
                  <tr>
                    <td>
                      For credit-scoring to assess this Application and to
                      verify your identity and that of the Other Individuals
                    </td>
                    <td>Contractual necessity</td>
                  </tr>
                </tbody>
              ...
              <p>
                <strong>
                  ...
                  ‘legitimate interests’ you have a right to object to our use
                  of Your Information. Please refer to Your rights section for
                  further details.
                </strong>
              </p>
              <p>
              ...
              <p>
                - Any organisation who introduced Us or who acts on Your behalf
                to allow them to provide services to you and/or to allow them to
                conduct, monitor and analyse their business;
                <br /> - Service providers, advisors and agents providing
                services to Us (including our group companies and Affiliates);
                <br /> - Card Schemes covered by the TOS;
                <br /> - VMAS™ and MATCH™ in order to report Customer’s business
                name and the name of Customer’s principals to the VMAS™ and
                MATCH™ listings pursuant to the Card Scheme Rules.
                <br /> - Anyone who has a legal right to require disclosure of
                your information or to whom we are permitted by law to disclose
                your information (this may include third parties such as
                bailiffs, receivers, the police and the courts);
                <br /> - Regulatory bodies where required for regulatory
                purposes;
                ...
                <br /> - Third party investors or potential investors in Elavon
                or its Affiliates or otherwise in the event of the sale,
                disposal, merger or transfer of the business of Elavon or its
                Affiliates, or obtaining financing for Elavon’s business, or
                negotiations in connection with that purpose.
              </p>
              <p>
              ...
              <p>
                You further acknowledge and agree that any information provided
                in connection with this Application and all other relevant
              ...
              <p>
                ...
                as strict as they are in the UK. If we do so we will put in
                place appropriate controls to ensure that Your Information is
                protected adequately, in particular through standard data
                protection model clauses adopted by the European Commission. For
                more information about these controls please contact us at
          ...
          <div className="row no-border page-break">
            <div className="cols-10">
              ...
              <p>
                ...
                <br /> - a right to ask Us to delete or correct any information
                We hold about them that is inaccurate;
                ...
                Union) if You believe that Your Information has not been
                processed in accordance with the requirements of the data
              ...
              <p>
                ...
                contact us at EUDataProtectionOffice@elavon.com.
              </p>
              <p>
                <strong>PROVISION OF INFORMATION ABOUT OTHER PEOPLE</strong>
              </p>
              <p>
                If you are providing personal information about other
                individuals in this Application, you must explain to those
                individuals whose personal details you have disclosed (“Other
                Individuals”), the categories of personal information that is
                being disclosed and all uses and processing of their personal
                data as detailed in this Application. This explanation must be
                provided to Other Individuals before you submit the Application
                to us.
              </p>
              <p>
              ...
              <p>
                IMPORTANT INFORMATION ABOUT PROCEDURES FOR OPENING AND
                MAINTAINING OF A MERCHANT SERVICES ACCOUNT. To ensure compliance
                with current legal and regulatory requirements aimed at
                preventing financial crime, money laundering and terrorist
                financing and to enable Us to proceed with your Application, We
                are required to obtain, verify and record information that
                identifies each person who opens up a merchant services account.
                We shall search your records and those of the Other Individuals
                at credit reference agencies who shall supply Us with
                information as well as information from the Electoral Register
                for the purpose of verifying your identity and that of the Other
                Individuals. Alternatively, We may ask you to provide physical
                forms of identification. Prior to our acceptance of this
                Application and from time to time thereafter, we may investigate
                the individual and business history and background of the
                Customer, each such representative and any other officers,
                partners, proprietors and/or owners of the Customer, and obtain
                credit reports or other background investigation reports on each
                of them that We consider necessary to review the acceptance and
              ...
              <p>
                ...
                Electoral Register for the purpose of verifying your identity
                and that of the Other Individuals. Credit reference agencies
                will record any credit searches on their file whether or not
                this Application proceeds.
              </p>
              <p>
                It is important that you give Us accurate details. We shall
                check your details and those of the Other Individuals with crime
                prevention agencies and if you give Us false or inaccurate
                information and We suspect fraud, We shall record this. We may
                disclose Your details and details of how you conduct your
                business and account to such agencies. This information may be
                used by other credit grantors for making decisions about you or
                people with whom you are financially associated. The information
                may also be used for prevention of financial crime and money
                laundering.
              </p>
              <p>
                ...
                it appears that We require further information from You, We
                shall request for this from You. Please note that unless and
                until we receive this additional information we cannot proceed
                with your Application. Please note that any such checks and
                inquiries may occur after opening of Your merchant services
                account, as they may be desirable or necessary to evaluate the
                continuance of the Agreement.
              </p>
              <p>
                If We are satisfied with the credit checks and other enquiries,
                this Application, the TOS and the Operating Guide, each updated
                by Us from time to time, will form your Agreement with Us.
              </p>
              <p>
              ...
              <p>
                ...
                terminal or similar device before completing any Transaction.
                The Customer understands that an AUTHORISATION CODE IS NOT A
                GUARANTEE OF ACCEPTANCE OR PAYMENT OF A TRANSACTION. RECEIPT OF
                AN AUTHORISATION CODE DOES NOT MEAN THAT THE CUSTOMER WILL NOT
              ...
              <p>
                ...
                Standards (“PCI DSS”). We require all Level 3 and Level 4
                Merchants (determined by Transaction volume) to validate PCI DSS
                compliance on an annual basis with initial validation to occur
                no later than ninety (90) days from when the Application has
                been accepted by Us. The Customer will be charged the PCI
                Charges further described in the Schedule of Fees. Further, if
                you are new to card payment processing, you must also comply
                with the requirements of the Payment Card Industry Payment
                Application Data Security Standard (“PCI PA DSS”). You must use
                a value added re-seller (“VAR”) whose payment application
                software (the software used to process the card payment
                transactions in a secure manner) is compliant with the PCI PA
                DSS.
              </p>
              <p>
                <strong>
                  It is very important that you read this Application, the TOS
                  and the Operating Guide, before you submit this Application.
                </strong>
              </p>
              <p>
              ...
              <p>
                ...
                accurate, properly reflects the business, financial condition
                and principal partners, owners or officers of the Customer; and
                (ii) the person submitting this Application is duly authorised
                to and has the power (corporate or otherwise) to bind the
                Customer to all provisions of this Application and the TOS.
                Transmission of a Transaction Receipt for a Transaction to
                Elavon, shall be the Customer’s acceptance of and agreement to
                the TOS.
              </p>
              <p>
                The submission by a representative of the Customer of this
                Application, or the transmission of a Transaction Receipt or
                other evidence of a Transaction to Us, shall be the Customer’s
                acceptance of and agreement to the terms and conditions
                contained in the Agreement, comprising, this Application, the
                TOS and the Operating Guide. The Customer agrees to comply with
                the Application, the TOS, the Operating Guide and all applicable
                laws, rules and regulations including the rules and regulations
                of the Card Schemes, and understands that failure to comply may
                result in termination of processing services. Words and phrases
                not specifically defined in this Application shall have the same
                meaning as set out in the TOS.
              </p>
              <p>
                <strong>
                  AUTHORISATION TO USE PERSONAL DATA FOR PAYMENT SERVICE
                  PURPOSES
                </strong>
              </p>
              <p>
                In order to provide the Merchant Services to You we need to
                access, retain and process personal data. You hereby authorise
                us to use personal data to enable us to provide the Merchant
                Services.
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="row no-border">
            ...
            <p>
              ...
              benefit you. We may do this by post, by telephone (including by
              way of automatic dialing), by fax or e-mail.
            </p>
          </div>
          <div className="row no-border">
            <div className="cols-10">
              <div className="input">
                <div className="check">
                  ...
                  <label htmlFor="af_s14_q1_1">
                    Tick this box if you do not wish to receive this
                    information, but remember this shall preclude you from
                    receiving any of our special offers or promotions.
                  </label>
                </div>
              </div>
            </div>
        ...
        <div className="footer">
          <p>
            ...
            Regulation Authority. Details of the Temporary Permissions Regime,
          ...
          <img src="logo.png" width={125} height="auto" alt="Elavon" />
        </div>
      </form>
    </>
  );
